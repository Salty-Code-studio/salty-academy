...
window.ACADEMY_EXTRAS = {
  p1: {
    ...
    speak: [
      {prompt:"What is a website for?", words:["Clarity","Trust","Next step"], points:[
      ...
      {prompt:"Explain the five second test", words:["Show","Ask","Gone"], points:[
      ...
      {prompt:"Why speed is money", words:["Blank","Silence","Gone"], points:[
      ...
      {prompt:"Proof beats promises", words:["Line","Evidence","Names"], points:[
