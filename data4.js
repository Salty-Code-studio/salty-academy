...
p1: {
  quiz: [
    {id:"q.p1.value-prop.c", c:["c.p1.value-prop"], q:"A friend shows you her new site: gorgeous photos, but you cannot tell what she actually sells. What is the problem?", a:["Pretty but not clear","Nothing, pretty sells","Too few pages","The photos are too big"], why:"Beautiful and vague still loses. Clear first, pretty second."},
    {id:"q.p1.speed.b", c:["c.p1.speed"], q:"Your customer opens your site on the beach, on slow hotel wifi. What matters most in that exact moment?", a:["It loads fast","The logo looks sharp","The about page","The color scheme"], why:"Three seconds of blank screen and they are back on Instagram. Speed is the front door."},
    {id:"q.p1.value-prop.d", c:["c.p1.value-prop"], q:"'We are passionate about quality.' What is wrong with this homepage line?", a:["Anyone could say it, so it says nothing","It is too short","Passion sounds unprofessional","Nothing, it builds trust"], why:"The copy-paste test: if a competitor could paste it, it proves nothing."},
    {id:"q.p1.bounce.a", c:["c.p1.bounce"], q:"A visitor lands, scrolls twice, leaves without tapping anything. In one word, what happened?", a:["A bounce","A conversion","A lead","A sale"], why:"Landed and left without doing anything: that is a bounce."},
    {id:"q.p1.proof.a", c:["c.p1.proof"], q:"Where do your best reviews belong on the site?", a:["Where people decide: up top, near the book button","In the footer","On a separate reviews page only","In small print"], why:"Proof works at the moment of doubt, not three scrolls after it."},
    {id:"q.p1.hero.b", c:["c.p1.hero","c.p1.value-prop"], q:"What is the one job of a homepage headline?", a:["Say what you sell, and for whom","Sound inspiring","Be short enough for a t-shirt","Mention how long you have existed"], why:"Clear beats clever. Every single time."},
    {id:"q.p1.cta.b", c:["c.p1.cta","c.p1.choice-overload"], q:"Above the fold you have three buttons: Book now, Learn more, Follow us. What is the fix?", a:["One button: Book now","Add a fourth option","Make all three bigger","Change the colors"], why:"One obvious next step. More choices means slower decisions means no decision."},
    {id:"q.p1.fold.a", c:["c.p1.fold"], q:"A cafe site has no opening hours listed. What does a hungry visitor actually do?", a:["Checks a competitor that does show them","Sends a polite email","Calls and waits","Drives over to look"], why:"Nobody works for information. The site with the answer gets the table."},
    {id:"q.p1.proof.b", c:["c.p1.proof"], q:"Which of these is real proof on a builder's website?", a:["Photos of jobs they actually did, with names","'Trusted by many happy clients'","A stock photo of a handshake","'Quality is our passion'"], why:"Real names, real work. The rest is wallpaper."},
    {id:"q.p1.five-second.b", c:["c.p1.five-second"], q:"Your aunt asks why her webshop 'does not work'. Visitors come, nobody buys. Your FIRST look is at...", a:["What visitors see in the first five seconds","Her logo files","Her business plan","Her competitors' prices"], why:"Plenty of visitors plus no buyers usually means the site fails speed, clarity or proof."}
  ],
  diagnose: [
    {id:"d.p1.five-second.a", c:["c.p1.five-second","c.p1.conversion"], say:"'People tap my Instagram link and then... nothing. No bookings.'", a:["Conversion: the page behind the link fails the five second test","Instagram: post more often","Pricing: too expensive"], why:"The link click proves interest. What happens in the next five seconds decides the booking."},
    {id:"d.p1.value-prop.a", c:["c.p1.value-prop","c.p1.proof"], say:"'My designer won an award with my site. I get zero calls.'", a:["Clarity and proof: award-pretty is not customer-clear","Phone provider issues","People do not call anymore"], why:"Design juries reward taste. Customers reward knowing what, for whom, what next."}
  ]
},
p2: {
  quiz: [
