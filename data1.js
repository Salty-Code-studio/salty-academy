...
window.ACADEMY_PART1 = [
{
  ...
  cards: [
    {t:"Conversion", d:"The moment a visitor does the thing you wanted: books, buys, messages, calls.", s:"turning visitors into customers"},
    {t:"Call to action (CTA)", d:"The button or line that tells the visitor what to do next.", s:"one clear next step"},
    {t:"Hero", d:"The big first section of a page: headline, image, main button.", s:"the first thing people see"},
    {t:"Above the fold", d:"Everything visible before scrolling. Prime real estate.", s:"before anyone even scrolls"},
    {t:"Load time", d:"How long from tap to usable page.", s:"how fast it opens"},
    {t:"First paint", d:"When the first real content appears on screen.", s:"the moment something shows up"},
    {t:"Bounce", d:"A visitor who lands and leaves without doing anything.", s:"people who leave straight away"},
    {t:"Friction", d:"Anything that makes the visitor think, wait, or guess.", s:"anything that makes people hesitate"},
    {t:"Social proof", d:"Evidence others already trust you: reviews, clients, real numbers.", s:"proof you have done this before"},
    {t:"Value proposition", d:"The one sentence explaining what you offer, for whom, and why you.", s:"what you do, in one sentence"},
    {t:"Five second test", d:"Show a homepage for 5 seconds, then ask: what, for whom, what next?", s:"the five second test"},
    {t:"Choice overload", d:"Too many options slow decisions down until no decision happens.", s:"too many choices means no choice"},
    {t:"Audit", d:"A structured review of a site against these principles, ending in a fix list.", s:"we look at your site the way a customer does"},
    {t:"Credibility", d:"Whether a stranger decides you look trustworthy and current.", s:"whether strangers trust you"}
  ],
  quiz: [
    {q:"What share of mobile visitors leave if a site takes more than 3 seconds to load?", a:["53%","25%","75%","90%"], why:"Google's mobile speed study: past 3 seconds, more than half are gone before the site even appears."},
    {q:"How many people judge a company's credibility by its website alone?", a:["75%","33%","50%","95%"], why:"Stanford's web credibility research: three quarters of first impressions are decided by pixels."},
    {q:"The three questions of the five second test are: what do they sell, who is it for, and...?", a:["What do I do next?","How much does it cost?","Where are they located?","How long have they existed?"], why:"Miss any of the three and a real visitor is already gone."},
    {q:"Why is a slow website more dangerous than an ugly one?", a:["Slow sites get silence, not complaints: visitors leave before seeing anything","Ugly sites are cheaper to fix","Google removes slow sites from search","Slow sites cost more in hosting"], why:"Nobody emails you about slowness. They just tap back, and you never hear about the customers you lost."},
    {q:"What is the three-part fix from the trust problem reel?", a:["Speed, clarity, proof","Design, content, SEO","Logo, colors, photos","Ads, content, email"], why:"Fast to the door, plain about the offer, evidence up front: the salesperson job description."},
    {q:"A good headline for a sail brand would be...", a:["Custom windsurfing sails, built on Bonaire","Ride the wind","Passion for performance","Welcome to our website"], why:"Clear beats clever, every time. Say what you sell, for whom."},
    {q:"What does a page without a call to action resemble?", a:["A sales pitch that ends with 'anyway, see you around'","A brochure, which is fine","A minimalist design choice","A trust signal"], why:"The CTA is the moment the salesperson asks for the sale. No ask, no sale."},
    {q:"The copy-paste test says proof is worthless if...", a:["A competitor could truthfully paste the same sentence on their site","It is longer than one sentence","It mentions a client by name","It includes a number"], why:"'We deliver quality' proves nothing because anyone can type it. '34-car booking platform on Aruba' passes."},
    {q:"Why do visitors leave when they have to guess?", a:["Guessing is effort and the back button is free","They dislike the colors","They prefer phoning businesses","They always compare five sites first"], why:"Every unclear thing is a small mental tax. Strangers do not pay taxes for you."},
    {q:"People do not read websites. They...", a:["scan them","print them","bookmark them","translate them"], why:"They arrive with a question, glance for a few seconds, and either see the answer or leave."}
  ],
  translate: [
    {setup:"A salon owner has never heard the word 'conversion'. Which explanation lands best?", a:["Say ten people walk into a shop and one buys. If we make it two, you doubled the business without one extra visitor.","We optimize your conversion funnel for maximal visitor-to-customer throughput.","Conversion means turning traffic into transactions via persuasive UX."], why:"The kitchen-table version uses a picture from her world. The others are jargon wearing a suit."},
    {setup:"Explain what a website is for, with zero terminology.", a:["Think of a shop with a dusty window and a sticky door. People walk past. We clean the window and oil the door.","A website is your digital storefront leveraging your brand presence.","A website is a 24/7 omnichannel touchpoint."], why:"The dusty window is instantly felt. 'Omnichannel touchpoint' is instantly forgotten."},
    {setup:"Explain social proof to someone who distrusts marketing talk.", a:["When two food stands sit side by side and one has a line, you join the line. Your website needs a visible line: real reviews, real photos, real names.","Social proof leverages herd psychology to derisk purchase decisions.","It is about building brand trust equity with testimonials."], why:"The food stand line is proof explained by a human. The others sound like the marketers he distrusts."}
  ],
  diagnose: [
    {say:"'People visit my site but nobody books.'", a:["Conversion: the site fails speed, clarity or proof","SEO: the site cannot be found","Branding: the logo is outdated"], why:"Visitors arriving means findability works. Falling out between look and book is Pack 01 territory."},
    {say:"'My site looks great on my laptop but customers say it is annoying on their phone.'", a:["Not responsive: built for the minority screen","Bad hosting: server too far away","Too few pages"], why:"Most visitors are on phones. A laptop-only site is optimized for the wrong device."}
  ]
},
{
